...
from service import delivery_handler, stock_updater
...
def create_stock():
  ...
  new_stock = {
    ...
    'register_medication': req_payload['register_medication'],
...
def create_medication_request(prescription_id):
  response = delivery_handler.submit_medication_request(prescription_id)
